...
More progress on the canvas of the Pomodoro Clock. Worked on CSS (still figuring out Flexbox things), have done some work with HTML5 canvas.

Day 3: June 15 Wednesday
Had some CSS breakthroughs, was happy at the end. Coded very late at night, after French.

Day 4: June 16 Thursday
Frustrating. Have spent a lot of time debugging the drawing functions of the timer. Grandfather called, had to code later at night than planned.

Day 5: June 17 Friday

Fix css issues, layout and switching between rest and work for the timer. It's Friday, so even though we came home late (we have our first wedding anniversary) I was able to put in my hour. At first it was a bit frustrating, but in the end I got a lot done. There are little fixes to be done to the timer, but the main functionality works.

Day 6: June 18 Saturday

Analyzed and improved increase/decrease session/break functionality, fixed some canvas display bugs. I was coding at the FreeCodeCamp meeting which felt really good because usually I just talk there.

Day 7: June 19 Sunday

Worked on canvas recognizing the display - retina vs regular, and some css work. I've managed to make it adapt to the kind of display it is used on, but there are still some small css issues to fix. I've made myself code even though I didn't want to do it so late at night on Sunday. Proud of myself today.

Week 2:

Day 8: June 20 Monday
Finished working on the Pomodoro Clock App and pushed it out.
